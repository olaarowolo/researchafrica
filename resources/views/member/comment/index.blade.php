    ...
    <div class="card shadow">
        <div class="card-header">
            ...
            <div class="d-flex justify-content-between align-content-center">
                ...
                @if (auth('member')->user()->member_type_id == 1 && $comment->correction_upload )

                <div class="">
                    <a type="button" download
                        href="{{ $comment->correction_upload ? $comment->correction_upload->getUrl() : 'javascript:void(0)' }}"
                        class="em-btn bg-dark">
                        <i class="fa fa-download" aria-hidden="true"></i> Download Commented File
                    </a>
                </div>
                @endif
            </div>
        ...
        <div class="card-body px-4">
            ...
            <main class="postcontent col-lg-12">
                ...
                <div class="form-widget">
                    ...
                    <form class="mb-4" action="{{ route('member.comment.article-update', $article->id) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea class="required form-control textarea" id="abstract" rows="20"
                                    name="abstract">{{ old('abstract', $sub_article->abstract ?? '') }}</textarea>
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                @else
                                <a href="{{ $sub_article->upload_paper->getUrl() }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($article_keywords as $id => $keyword)
