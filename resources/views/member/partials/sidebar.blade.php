    ...
    <div class="p-4 pt-5">
        ...
        <ul class="list-unstyled components mb-5">
            ...
            @if ($user->member_type_id == 3)
                <li>
                    <a href="{{ route('member.profile') }}"><i class="fa-sharp fa-solid fa-list"></i> Reviewer's
                        Page</a>
                </li>
            @endif
            ...
            <!-- Editorial Workflows -->
            @if (in_array($user->member_type_id, [1, 2, 3, 6]))
                <!-- Author, Editor, Reviewer types -->
                <li>
                    <a href="{{ route('member.editorial-workflows.dashboard') }}">
