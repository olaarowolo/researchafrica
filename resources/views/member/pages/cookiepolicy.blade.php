...
@section('content')
    ...
    <section id="content">
        ...
        <div id="content" class="container card kb-prose-base ">
            <div class="card-header">
              <p class="MsoNormal" style="line-height: 27.0pt; mso-outline-level: 1; margin: 8.05pt 0in 8.05pt 0in;">
                <strong>
                  <span lang="EN-GB" style="font-size: 24.0pt; font-family: 'poppins','sans-serif''; color: #333333; mso-font-kerning: 18.0pt;"> Cookie Policy </span>
                </strong>
              </p>
            </div>
            <div class=".text-primary">
              <div class="card-body container md:kb-px-5" "MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto;>
                        <p class=">
                <span lang="EN-GB" style="font-family: 'poppins','sans-serif'; color: #333333;">
                  <html>
                    <style>
                      ...
                      ol {
                        padding-left: 1.0em; /* Adjust the value as needed */
                      }
                    ...
                    <body>
                    <p>
                      Last updated: 13 November 2023 <br><br>
                      This is the Cookies Policy (the "Policy") for <a href="https://researchafricapublications.com/" target="_blank" style="color: blue; text-decoration: none;"> RESEARCH AFRICA PUBLICATIONS</a> accessible from https://researchafricapublications.com/. To make this site function properly, we sometimes place small data files called cookies on your device. These cookies are downloaded to your computer to improve your browsing experience as well as other purposes that are outlined in this Policy. <br><br>

                      Accordingly, this Policy is a legally binding agreement between you ("user," "visitor," "you," or "your") and this Website administrator or operator ("administrator," "operator," "we," "us," or "our"). This cookies policy page describes what cookies are, what information they gather, why, and how they're being used by <a href="https://researchafricapublications.com/" target="_blank" style="color: blue; text-decoration: none;"> RESEARCH AFRICA PUBLICATIONS</a> and any of its related products and services (the "Services"). We will also share how to control and disable these cookies and withdraw consent to collect cookies. However, please know that these actions may downgrade some aspects of this site's functionality.
                    ...
                    <p>
                      <strong>
                        <span lang="EN-GB" style="font-size: 18.0pt; font-family: 'poppins','sans-serif''; color: #333333; mso-font-kerning: 18.0pt;">   What Are Cookies </span>
                      </strong>
                      <br><br>
                      ...
                      <strong>
                        <span lang="EN-GB" style="font-size: 18.0pt; font-family: 'poppins','sans-serif''; color: #333333; mso-font-kerning: 18.0pt;">  How We Use Cookies
                        </span>
                      </strong>
                      <br><br>
                      ...
                      <strong>
                        <span lang="EN-GB" style="font-size: 18.0pt; font-family: 'poppins','sans-serif''; color: #333333; mso-font-kerning: 18.0pt;">  How to Control Cookies</span>
                      </strong>
                      <br><br>
                      ...
                      <strong>
                        <span lang="EN-GB" style="font-size: 18.0pt; font-family: 'poppins','sans-serif''; color: #333333; mso-font-kerning: 18.0pt;">   Disabling Cookies
                        </span>
                      </strong>
                      <br><br>
                      ...
                      <strong>
                        <span lang="EN-GB" style="font-size: 18.0pt; font-family: 'poppins','sans-serif''; color: #333333; mso-font-kerning: 18.0pt;">   The Cookies We Use </span>
                      </strong>
                      ...
                      <p >
                        <ol>
                          ...
                          <h4></h4>Functionality Cookies</h4>
                      ...
                      <strong>
                        <span lang="EN-GB" style="font-size: 18.0pt; font-family: 'poppins','sans-serif''; color: #333333; mso-font-kerning: 18.0pt;">   Third-Party Cookies</span>
                      </strong>
                      <br>
                      ...
                      <strong>
                        <span lang="EN-GB" style="font-size: 18.0pt; font-family: 'poppins','sans-serif''; color: #333333; mso-font-kerning: 18.0pt;">   Amendments and Modifications
                        </span>
                      </strong>
                      <br><br>
                      ...
                      <p>
                        ...
                        <a href="https://researchafricapublications.com/" target="_blank" style="color: blue; text-decoration: none;"> RESEARCH AFRICA PUBLICATIONS</a> reserves the right to modify this Policy and its terms as they relate to this website and services at any time, effective and in full force upon posting the updated version on the website. <br> <br>
                      ...
                      <strong>
                        <span lang="EN-GB" style="font-size: 18.0pt; font-family: 'poppins','sans-serif''; color: #333333; mso-font-kerning: 18.0pt;">   Policy Acceptance </span>
                      </strong>
                      <br><br>
                    ...
                    <strong>
                      <span lang="EN-GB" style="font-size: 18.0pt; font-family: 'poppins','sans-serif''; color: #333333; mso-font-kerning: 18.0pt;">   More Information </span>
                    </strong>
                    <br><br>

                    <p>

                      We trust that you have gained clarity concerning our use of cookies. For further information about our cookies policy, please email us at <a href="mailto:info@researchafricapublications.com" target="_blank" style="color: blue; text-decoration: none;"> info@researchafricapublications.com</a>
