    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <h1
                                style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 28px;">
                                {{ $data['name'] }}
                            </h1>
                            <div style="font-weight: 200;line-height: 25px;">
                                {{ $data['email'] }}
                            </div>
                            <div style="font-weight: 200;line-height: 25px;">
                                {{ $data['phone'] }}
        ...
        <![endif]-->
                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                            <p style="margin: 0;">
                                {{ $data['message'] }}
