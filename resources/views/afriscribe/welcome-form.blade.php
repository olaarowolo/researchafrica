        ...
        <div class="form-container">
            ...
            <form id="quoteForm" class="quote-form" method="post" action="{{ route('afriscribe.quote-request.store') }}"
                ...
                <div style="display:flex;gap:8px;margin-top:12px;align-items:center">
                    ...
                    <button type="submit" class="btn" id="submitBtn" style="opacity:0.95">Submit
                        request</button>
                </div>

                <p class="small muted" style="margin-top:10px">We will email you directly with the confirmed quote.
                    Note: large files may be requested via secure link if attachment exceeds mail limits.</p>
            </form>
        </div>
    </section>
