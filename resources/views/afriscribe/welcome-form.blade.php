...
<body>
    ...
    <nav class="navbar">
        <a href="{{ route('afriscribe.welcome') }}" class="logo">
            ...
            <img src="/public/afriscribe/img/afriscribe-logo-white.png" alt="AfriScribe Logo" style="height: 60px; width: auto;">
        </a>
        <ul class="nav-links">
    ...
    <section class="hero">
        ...
        <p>Integrated solutions for manuscripts, proofreading, analytics, and beyond. Streamline your academic publishing workflow with AfriScribe's comprehensive platform.</p>
    ...
    <section id="services" class="services">
        <div class="card">
            ...
            <p>SaaS-based platform for submission, peer review, and editorial management. Complete workflow automation for academic journals.</p>
        </div>
        <div class="card">
            <div class="card-icon">✏️</div>
            <h3>AfriScribe Proofread</h3>
            <p>Professional proofreading to prepare manuscripts for global standards. Expert editors ensure publication-ready quality.</p>
        </div>
        <div class="card">
            <div class="card-icon">📊</div>
            <h3>AfriScribe Insights</h3>
            <p>Real-time analytics to guide editorial strategy and reviewer engagement. Data-driven insights for better publishing decisions.</p>
        </div>
        <div class="card">
            <div class="card-icon">🤝</div>
            <h3>AfriScribe Connect</h3>
            <p>Collaboration hub for authors, editors, and reviewers. Seamless communication and project management tools.</p>
        </div>
        <div class="card">
            <div class="card-icon">📚</div>
            <h3>AfriScribe Archive</h3>
            <p>Cloud-based repository for long-term preservation with DOIs. Secure, searchable, and permanently accessible archives.</p>
        </div>
        <div class="card">
            <div class="card-icon">⚙️</div>
            <h3>AfriScribe Editor</h3>
            <p>Editorial toolkit with configurable peer review workflows. Customizable processes to match your journal's needs.</p>
        </div>
    </section>
    ...
    <section id="request" class="form-section">
        <div class="form-container">
            ...
            <p class="small muted" style="margin:0 0 12px">Download the rate card first, then submit your document for an email-only quote.</p>

            <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap">
              <a class="btn secondary" href="/files/AfriScribe-UK-RateCard.pdf" target="_blank" rel="noopener">Download UK rate card</a>
              <a class="btn secondary" href="/files/AfriScribe-NG-RateCard.pdf" target="_blank" rel="noopener">Download Nigeria rate card</a>
            </div>

            <form id="quoteForm" class="quote-form" method="post" action="/afriscribe/request" enctype="multipart/form-data" novalidate>
              ...
              <div class="row">
                ...
                <div class="field half">
                  ...
                  <input id="wordCount" name="word_count" type="number" min="100" step="1" placeholder="e.g. 4500" />                  <div class="small muted">Rates apply per 1,000 words; we round up to the next 1,000.</div>
                </div>
              </div>
              ...
              <div class="row" style="margin-top:8px">
                <div class="field">
                  ...
                  <div style="display:flex;gap:8px;flex-wrap:wrap">
                    <label style="display:inline-flex;gap:8px;align-items:center"><input type="checkbox" id="addon_rush" name="addons[]" value="rush"> Rush (48h)</label>
                    <label style="display:inline-flex;gap:8px;align-items:center"><input type="checkbox" id="addon_plag" name="addons[]" value="plag"> Plagiarism check</label>
                  </div>
                </div>
              </div>
              ...
              <div class="row" style="margin-top:10px">
                <div class="field">
                  ...
                  <div id="drop" class="drop" tabindex="0" aria-label="File upload dropzone">
                    <div id="dropText">Drag & drop file here, or click to browse (DOC, DOCX, PDF, TXT — max 10MB)</div>
                    <input id="fileInput" name="file" type="file" accept=".doc,.docx,.pdf,.txt" style="display:none" required>
                  </div>
                  <div id="fileHint" class="small muted" style="margin-top:8px">Your file will be attached to the admin email only.</div>
                </div>
              </div>
              ...
              <p class="small muted" style="margin-top:10px">We will email you directly with the confirmed quote. Note: large files may be requested via secure link if attachment exceeds mail limits.</p>
            </form>
        </div>
    </section>
