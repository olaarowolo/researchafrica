...
<div class="c-sidebar c-sidebar-fixed c-sidebar-lg-show modern-sidebar shadow-lg" id="sidebar" role="navigation"
    aria-label="Main navigation">

    <!-- Sidebar Brand -->
    <div class="c-sidebar-brand d-md-down-none">
        <a class="w-100 d-flex align-items-center text-decoration-none" href="{{ route('admin.home') }}"
            aria-label="Go to dashboard">
            <img src="{{ $setting && $setting->logo ? $setting->logo->getUrl() : 'https://placehold.co/40x40/6c757d/ffffff?text=Logo' }}"
                alt="Logo" width="40" height="40" class="me-3 rounded-circle shadow-sm" loading="lazy"
    ...
    <ul class="c-sidebar-nav list-unstyled p-3 mb-0">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link d-flex align-items-center py-2 px-3 rounded-2 text-decoration-none transition-all {{ request()->is('admin/home*') ? 'is-active' : '' }}"
                href="{{ route('admin.home') }}" aria-label="Dashboard"
        ...
        <li class="c-sidebar-nav-dropdown">
            <a class="c-sidebar-nav-dropdown-toggle d-flex align-items-center py-2 px-3 rounded-2 text-decoration-none transition-all"
                href="#" data-dropdown="research-africa-dropdown" aria-expanded="false"
            ...
            <ul id="research-africa-dropdown"
                class="c-sidebar-nav-dropdown-items list-unstyled shadow-sm rounded-2 mt-2"
                style="background: linear-gradient(135deg, #e8f5e8 0%, #c8e6c9 100%); border: none; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); transition: all 0.3s ease;">
                <!-- Member Management -->
                ...
                @can('article_category_access')
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link d-flex align-items-center py-2 text-decoration-none transition-all {{ request()->is('admin/article-sub-categories*') ? 'is-active is-child-active' : '' }}"
                            href="{{ route('admin.article-sub-categories.index') }}" aria-label="Article Journal"
                            style="color: #2e7d32; border-radius: 8px; margin: 4px; padding: 10px 16px !important;">
                            <i class="fa-fw fas fa-folder c-sidebar-nav-icon me-3" aria-hidden="true"></i>
                ...
                @can('article_category_access')
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link d-flex align-items-center py-2 text-decoration-none transition-all {{ request()->is('admin/article-keywords*') ? 'is-active is-child-active' : '' }}"
                            href="{{ route('admin.article-keywords.index') }}" aria-label="{{ __('Article Keyword') }}"
                            style="color: #2e7d32; border-radius: 8px; margin: 4px; padding: 10px 16px !important;">
                ...
                @can('article_access')
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link d-flex align-items-center py-2 text-decoration-none transition-all {{ request()->is('admin/articles*') ? 'is-active is-child-active' : '' }}"
                            href="{{ route('admin.articles.index') }}" aria-label="{{ trans('cruds.article.title') }}"
                            style="color: #2e7d32; border-radius: 8px; margin: 4px; padding: 10px 16px !important;">
                ...
                <!-- Editorial Workflows -->
                @can('editorial_workflow_access')
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link d-flex align-items-center py-2 text-decoration-none transition-all {{ request()->is('admin/editorial-workflows*') ? 'is-active is-child-active' : '' }}"
                            href="{{ route('admin.editorial-workflows.index') }}" aria-label="Editorial Workflows"
                            style="color: #2e7d32; border-radius: 8px; margin: 4px; padding: 10px 16px !important;">
                            <i class="fa-fw fas fa-project-diagram c-sidebar-nav-icon me-3" aria-hidden="true"></i>
                            <span class="submenu-text">Editorial Workflows</span>
                        </a>
                    </li>
                @endcan
                ...
                @can('comment_access')
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link d-flex align-items-center py-2 text-decoration-none transition-all {{ request()->is('admin/comments*') ? 'is-active is-child-active' : '' }}"
                            href="{{ route('admin.comments.index') }}" aria-label="{{ trans('cruds.comment.title') }}"
                            style="color: #2e7d32; border-radius: 8px; margin: 4px; padding: 10px 16px !important;">
                ...
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link d-flex align-items-center py-2 px-3 rounded-2 text-decoration-none transition-all {{ request()->is('admin/abouts*') ? 'is-active' : '' }}"
                        href="{{ route('admin.abouts.index') }}" aria-label="About Us"
                ...
                @can('country_access')
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link d-flex align-items-center py-2 text-decoration-none transition-all {{ request()->is('admin/countries*') ? 'is-active is-child-active' : '' }}"
                            href="{{ route('admin.countries.index') }}" aria-label="{{ trans('cruds.country.title') }}"
                            style="color: #2e7d32; border-radius: 8px; margin: 4px; padding: 10px 16px !important;">
                ...
                @can('setting_access')
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link d-flex align-items-center py-2 text-decoration-none transition-all {{ request()->is('admin/settings*') ? 'is-active is-child-active' : '' }}"
                            href="{{ route('admin.settings.index') }}" aria-label="{{ trans('cruds.setting.title') }}"
                            style="color: #2e7d32; border-radius: 8px; margin: 4px; padding: 10px 16px !important;">
                            <i class="fa-fw fas fa-cogs c-sidebar-nav-icon me-3" aria-hidden="true"></i>
        ...
        @can('faq_management_access')
            <li
                class="c-sidebar-nav-dropdown {{ request()->is('admin/faq-categories*') || request()->is('admin/faq-questions*') ? 'open' : '' }}">
                <a class="c-sidebar-nav-dropdown-toggle d-flex align-items-center py-2 px-3 rounded-2 text-decoration-none transition-all"
                    href="#" data-dropdown="faq-management-dropdown"
                ...
                <ul id="faq-management-dropdown"
                    class="c-sidebar-nav-dropdown-items list-unstyled shadow-sm rounded-2 mt-2 {{ request()->is('admin/faq-categories*') || request()->is('admin/faq-questions*') ? 'show' : '' }}">
        ...
        @can('content_management_access')
            <li
                class="c-sidebar-nav-dropdown {{ request()->is('admin/content-categories*') || request()->is('admin/content-tags*') || request()->is('admin/content-pages*') ? 'open' : '' }}">
                <a class="c-sidebar-nav-dropdown-toggle d-flex align-items-center py-2 px-3 rounded-2 text-decoration-none transition-all"
                    href="#" data-dropdown="content-management-dropdown"
                ...
                <ul id="content-management-dropdown"
                    class="c-sidebar-nav-dropdown-items list-unstyled shadow-sm rounded-2 mt-2 {{ request()->is('admin/content-categories*') || request()->is('admin/content-tags*') || request()->is('admin/content-pages*') ? 'show' : '' }}">
        ...
        @can('user_management_access')
            <li
                class="c-sidebar-nav-dropdown {{ request()->is('admin/permissions*') || request()->is('admin/roles*') || request()->is('admin/users*') ? 'open' : '' }}">
                <a class="c-sidebar-nav-dropdown-toggle d-flex align-items-center py-2 px-3 rounded-2 text-decoration-none transition-all"
                    href="#" data-dropdown="user-management-dropdown"
                ...
                <ul id="user-management-dropdown"
                    class="c-sidebar-nav-dropdown-items list-unstyled shadow-sm rounded-2 mt-2 {{ request()->is('admin/permissions*') || request()->is('admin/roles*') || request()->is('admin/users*') ? 'show' : '' }}">
                    ...
                    @can('role_access')
                        <li class="c-sidebar-nav-item">
                            <a class="c-sidebar-nav-link d-flex align-items-center py-2 text-decoration-none transition-all {{ request()->is('admin/roles*') ? 'is-active is-child-active' : '' }}"
                                href="{{ route('admin.roles.index') }}" aria-label="{{ trans('cruds.role.title') }}"
                    ...
                    @can('user_access')
                        <li class="c-sidebar-nav-item">
                            <a class="c-sidebar-nav-link d-flex align-items-center py-2 text-decoration-none transition-all {{ request()->is('admin/users*') ? 'is-active is-child-active' : '' }}"
                                href="{{ route('admin.users.index') }}" aria-label="{{ trans('cruds.user.title') }}"
        ...
        @can('subscription_management_access')
            <li
                class="c-sidebar-nav-dropdown {{ request()->is('admin/subscriptions*') || request()->is('admin/member-subscriptions*') ? 'open' : '' }}">
                <a class="c-sidebar-nav-dropdown-toggle d-flex align-items-center py-2 px-3 rounded-2 text-decoration-none transition-all"
                    href="#" data-dropdown="subscription-management-dropdown"
                ...
                <ul id="subscription-management-dropdown"
                    class="c-sidebar-nav-dropdown-items list-unstyled shadow-sm rounded-2 mt-2 {{ request()->is('admin/subscriptions*') || request()->is('admin/member-subscriptions*') ? 'show' : '' }}">
            ...
            @can('profile_password_edit')
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link d-flex align-items-center py-2 px-3 rounded-2 text-decoration-none transition-all {{ request()->is('profile/password') || request()->is('profile/password/*') ? 'is-active' : '' }}"
                        href="{{ route('profile.password.edit') }}" aria-label="{{ trans('global.change_password') }}"
                        aria-current="{{ request()->is('profile/password*') ? 'page' : 'false' }}">
                        <i class="fa-fw fas fa-key c-sidebar-nav-icon me-3" aria-hidden="true"></i>
        ...
        dropdownToggles.forEach(toggle => {
            toggle.addEventListener('click', function(e) {
                ...
                if (target) {
                    ...
                    document.querySelectorAll('.c-sidebar-nav-dropdown-items.show').forEach(
                        openItem => {
                            if (openItem !== target) {
                                openItem.classList.remove('show');
                                openItem.closest('.c-sidebar-nav-dropdown').classList
                                    .remove('open');
                            }
                        });
