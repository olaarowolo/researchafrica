            ...
            <form method="POST" action="{{ route('admin.articles.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('corresponding_authors') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('corresponding_authors') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('institute_organization') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('institute_organization') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('access_type') ? 'is-invalid' : '' }}"
                        ...
                        @foreach (\App\Models\Article::ACCESS_TYPE as $id => $access)
                            <option value="{{ $id }}" {{ old('access_type') == $id ? 'selected' : '' }}>
                                {{ $access }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3" style="display: none;" id="amountTab">
                    ...
                    <input type="number" class="form-control" name="amount" id="amount"
                        aria-describedby="amounthelpId" placeholder="amount" value="{{ old('amount') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('article_status') ? 'is-invalid' : '' }}"
                        ...
                        @foreach (App\Models\Article::ARTICLE_STATUS as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('article_status') === (string) $key ? 'selected' : '' }}>
                                {{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control {{ $errors->has('publish_date') ? 'is-invalid' : '' }}"
                        name="publish_date" value="{{ old('publish_date') }}" id="publish_date"
                        aria-describedby="helpId" placeholder="Article Publish Date">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('volume') ? 'is-invalid' : '' }}"
                        name="volume" value="{{ old('volume') }}" id="volume" aria-describedby="helpId"
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        name="issue_no" value="{{ old('issue_no') }}" id="issue_no" aria-describedby="helpId"
                        placeholder="Article Issue No">
                ...
                <div class="form-group">
                    ...
                    <input type="url"
                        class="form-control {{ $errors->has('doi_link') ? 'is-invalid' : '' }}"
                        name="doi_link" value="{{ old('doi_link') }}" id="doi_link" aria-describedby="helpId"
