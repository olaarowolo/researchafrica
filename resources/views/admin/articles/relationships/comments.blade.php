...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-comments">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.comment.fields.article') }}
                        </th>
                        <th>
                            {{ trans('cruds.comment.fields.member') }}
                        </th>
                        <th>
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-comments:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
