...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-memberArticles">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $article->id }}">
                        ...
                        <td>
                            @if($article->upload_paper)
                            <a href="{{ $article->upload_paper->getUrl() }}" target="_blank">
                        ...
                        <td>
                            {{ App\Models\Article::ARTICLE_STATUS[$article->status] ?? '' }}
                        </td>
                        <td>
                            @can('article_show')
...
@endcan
  ...
  let table = $('.datatable-memberArticles:not(.ajaxTable)').DataTable({ buttons: dtButtons })
