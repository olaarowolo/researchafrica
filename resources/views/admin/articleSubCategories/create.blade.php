...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.article-sub-categories.store") }}" enctype="multipart/form-data">
            @csrf

            <div class="form-group">
                <label for="parent_id" class="form-label required">Article Category</label>
            ...
            <div class="form-group">
                <label class="required" for="category_name">Journal Name</label>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="mb-3">
                      ...
                      <input type="text"
                        class="form-control" name="issn" value="{{ old('issn') }}" id="issn" aria-describedby="helpId" placeholder="ISSN Number">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="mb-3">
                      ...
                      <input type="text"
                        class="form-control" name="online_issn" value="{{ old('online_issn') }}" id="online_issn" aria-describedby="helpId" placeholder="Online ISSN Number">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="url"
                        class="form-control" name="doi_link" value="{{ old('doi_link') }}" id="doi_link" aria-describedby="helpId" placeholder="e.g- https://doi.org/10.47366/sabia.v5n1a3">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
            ...
            <div class="form-group">
                ...
                <div class="drop-zone">
                    <input class="form-control {{ $errors->has('cover_image') ? 'is-invalid' : '' }}" type="file" name="cover_image" id="cover_image" value="{{ old('cover_image', '') }}" required accept="image/*" style="display: none;">
                    <div class="drop-zone-text">            
                        <i class="fas fa-cloud-upload-alt"></i>
                        Drag and drop files here or click to select</div>
                </div>
            ...
            {{-- <div class="form-group">
                <label class="required" for="cover_image">Upload Journal Cover Image</label>
                <input class="form-control {{ $errors->has('cover_image') ? 'is-invalid' : '' }}" type="file" name="cover_image" id="cover_image" value="{{ old('cover_image', '') }}" required accept="image/*">
                @if($errors->has('cover_image'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cover_image') }}
                    </div>
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control textarea" name="aim_scope" id="aim_scope"></textarea>
            </div>

            <div class="mb-3">
              <label for="editorial_board" class="form-label required">Editorial Board</label>
              <textarea class="form-control textarea" name="editorial_board" id="editorial_board"></textarea>
            </div>

            <div class="mb-3">
              <label for="submission" class="form-label required">Submission</label>
              <textarea class="form-control textarea" name="submission" id="submission"></textarea>
            </div>

            <div class="mb-3">
              <label for="subscribe" class="form-label required">Subscribe</label>
              <textarea class="form-control textarea" name="subscribe" id="subscribe"></textarea>
            </div>
