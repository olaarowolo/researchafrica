...
class QuoteRequestFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'original_filename' => $this->faker->optional(0.8)->file('path/to/documents', false),
            'file_path' => $this->faker->optional(0.8)->word() . '.docx',
    ...
    {
        return $this->state(fn (array $attributes) => [
            'original_filename' => $this->faker->file('path/to/documents', false),
